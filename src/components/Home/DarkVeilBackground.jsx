// src/components/Home/DarkVeilBackground.jsx

import React, { useRef, useEffect } from 'react';
import { Renderer, Program, Mesh, Triangle, Vec2 } from 'ogl';

// --- GLSL SHADER CODE (CLEANED) ---
const vertex = `
...
`;
// --- END OF CLEANED FRAGMENT SHADER ---
...
const DarkVeilBackground = ({
    ...
    const loop = () => {
        ...
        // CRITICAL: Ensure all objects exist before trying to use them
    ...
    useEffect(() => {
        ...
        const cleanup = () => {
            ...
            // Optionally: dispose of ogl objects here if needed, but simple cleanup is often sufficient
        };
        ...
        // Initial resize is critical for rendering
        resize();
